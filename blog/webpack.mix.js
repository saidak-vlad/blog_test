...
mix.styles([
    'resource/admin/bootstrap/css/bootstrap.min.css',
    'resource/admin/font-awesome/4.5.0/css/font-awesome.min.css',
    'resource/admin/ionicons/2.0.1/css/ionicons.min.css',
    'resource/admin/dist/css/AdminLTE.min.css',
    'resource/admin/dist/css/skins/_all-skins.min.css',
], 'public/css/admin.css');

mix.scripts([
    'resource/admin/plugins/jQuery/jquery-2.2.3.min.js',
    'resource/admin/bootstrap/js/bootstrap.min.js',
    'resource/admin/plugins/slimScroll/jquery.slimscroll.min.js',
    'resource/admin/plugins/fastclick/fastclick.js',
    'resource/admin/dist/js/app.min.js',
    'resource/admin/dist/js/demo.js',
],'public/js/admin.js');
